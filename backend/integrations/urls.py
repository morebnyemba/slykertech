...
from .views import (APIConfigurationViewSet, IntegrationCredentialViewSet, 
                   cPanelAccountViewSet, DirectAdminAccountViewSet)

router = DefaultRouter()
router.register(r'api-configs', APIConfigurationViewSet, basename='api-config')
