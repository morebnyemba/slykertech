...
import { FaServer, FaCheck, FaArrowLeft, FaShieldAlt } from 'react-icons/fa';
  ...
  const fetchProducts = async () => {
    try {
      ...
      if (response.data) {
        ...
        // Filter for dedicated hosting only
        const dedicatedProducts = results.filter((p: HostingProduct) => p.hosting_type === 'dedicated');
        setProducts(dedicatedProducts);
      } else {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-xl">Loading dedicated server products...</div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Maximum performance and control with enterprise-grade dedicated servers
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-16">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg text-center">
            ...
            <h3 className="font-bold text-gray-900 dark:text-white mb-2">Bare Metal Power</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">No virtualization overhead</p>
          </div>
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg text-center">
            <FaShieldAlt className="w-12 h-12 text-blue-600 mx-auto mb-4" />
            <h3 className="font-bold text-gray-900 dark:text-white mb-2">Enterprise Security</h3>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg text-center">
            ...
            <h3 className="font-bold text-gray-900 dark:text-white mb-2">100% Resources</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">All resources dedicated to you</p>
          </div>
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg text-center">
            <FaServer className="w-12 h-12 text-blue-600 mx-auto mb-4" />
            <h3 className="font-bold text-gray-900 dark:text-white mb-2">99.99% Uptime SLA</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">Maximum reliability</p>
          </div>
        </div>
        ...
        {products.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-xl text-gray-600 dark:text-gray-400">
              No dedicated server products available yet.
            </p>
          </div>
        ) : (
