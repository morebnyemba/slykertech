...
import { FaServer, FaCheck, FaArrowLeft, FaCloud } from 'react-icons/fa';
  ...
  const fetchProducts = async () => {
    try {
      ...
      if (response.data) {
        ...
        // Filter for VPS hosting only
        const vpsProducts = results.filter((p: HostingProduct) => p.hosting_type === 'vps');
        setProducts(vpsProducts);
      } else {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-xl">Loading VPS hosting products...</div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Scalable virtual private servers with dedicated resources for growing applications
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-16">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg text-center">
            ...
            <h3 className="font-bold text-gray-900 dark:text-white mb-2">Dedicated Resources</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">Guaranteed CPU & RAM</p>
          </div>
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg text-center">
            <FaServer className="w-12 h-12 text-blue-600 mx-auto mb-4" />
            <h3 className="font-bold text-gray-900 dark:text-white mb-2">Full Root Access</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">Complete control</p>
          </div>
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg text-center">
            <FaCheck className="w-12 h-12 text-blue-600 mx-auto mb-4" />
            <h3 className="font-bold text-gray-900 dark:text-white mb-2">SSD Storage</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">Lightning fast performance</p>
          </div>
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg text-center">
            <FaCloud className="w-12 h-12 text-blue-600 mx-auto mb-4" />
            <h3 className="font-bold text-gray-900 dark:text-white mb-2">Easy Scaling</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">Upgrade anytime</p>
          </div>
        </div>
        ...
        {products.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-xl text-gray-600 dark:text-gray-400">
              No VPS hosting products available yet.
            </p>
          </div>
        ) : (
