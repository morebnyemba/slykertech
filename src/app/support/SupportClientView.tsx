...
export default function SupportClientView() {
    ...
    const channelsRef = useStaggerReveal<HTMLElement>();
    const hoursRef = useScrollReveal<HTMLElement>();
    const faqsRef = useStaggerReveal<HTMLElement>();
    const resourcesRef = useStaggerReveal<HTMLElement>();
    ...
    return (
        <div className="relative z-10">
            ...
            {/* Support Channels */}
            <section ref={channelsRef} className="scroll-reveal py-24 px-4 sm:px-8 bg-white dark:bg-gray-950">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {supportChannels.map((channel, index) => (
                            <div
                                key={index}
                                className="scroll-reveal-child p-8 bg-gray-50 dark:bg-gray-900 rounded-2xl hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
                            >
            ...
            {/* Support Hours */}
            <section ref={hoursRef} className="scroll-reveal py-16 px-4 sm:px-8 bg-gray-50 dark:bg-gray-900">
                <div className="max-w-6xl mx-auto">
            ...
            {/* FAQs */}
            <section ref={faqsRef} className="scroll-reveal py-24 px-4 sm:px-8 bg-white dark:bg-gray-950">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="space-y-6">
                        {faqs.map((faq, index) => (
                            <div
                                key={index}
                                className="scroll-reveal-child p-6 bg-gray-50 dark:bg-gray-900 rounded-xl hover:shadow-md transition-all duration-300"
                            >
            ...
            {/* Resources */}
            <section ref={resourcesRef} className="scroll-reveal relative py-24 px-4 sm:px-8 bg-gray-50 dark:bg-gray-900">
                ...
                <div className="relative max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="scroll-reveal-child p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
