...
const metadata: Metadata = {
  ...
  description:
    "Discover Slyker Tech's mission, vision, and expertise in providing professional web development, hosting, and digital solutions across Africa and globally.",
